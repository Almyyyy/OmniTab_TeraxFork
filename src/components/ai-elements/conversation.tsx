...
import { ArrowDown01Icon, Download01Icon } from "@/components/icons";
  ...
  return (
    !isAtBottom && (
      <Button
        ...
        {...props}
      >
        <AppIcon icon={ArrowDown01Icon} size={13} strokeWidth={2} />
      </Button>
    )
  );
};
...
export const ConversationDownload = ({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <AppIcon icon={Download01Icon} size={16} />}
    </Button>
  );
};
