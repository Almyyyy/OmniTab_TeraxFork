...
export const DEFAULT_THEME_ID = "omnitab-default";
...
const STORE_PATH = "omnitab-settings.json";
...
// window can listen.
const PREFS_CHANGED_EVENT = "omnitab://prefs-changed";
...
const KEYS_CHANGED_EVENT = "omnitab://ai-keys-changed";
