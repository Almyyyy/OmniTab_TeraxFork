...
const REPO_URL = "https://github.com/OmniTabOrg/OmniTab_TeraxFork";
const WEBSITE = "https://omnitab.app";
...
export function AboutSection() {
  ...
  const [name, setName] = useState("OmniTab");
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <dl className="grid grid-cols-[110px_1fr] gap-y-2.5 text-[12px]">
        ...
        <dd className="font-mono text-[11.5px]">app.almyyyy.omnitab</dd>
